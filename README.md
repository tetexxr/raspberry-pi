...
- [Configuración](#configuracion)
	- [Averiguar la dirección ip de la Raspberry Pi 2](#averiguar-la-direccion-ip-de-la-raspberry-pi-2)
...
- [Comandos básicos que hay que conocer](#comandos-basicos-que-hay-que-conocer)
	- [Mostrar información sobre el hardware](#mostrar-informacion-sobre-el-hardware)
	- [Los comandos más importantes](#los-comandos-mas-importantes)
	- [Comandos de búsqueda](#comandos-de-busqueda)
...
------------------------------------------------------------------------------------------------
Para configurar la red, todo dependerá de lo que queramos. En mi caso, quiero que el cable ethernet sea siempre prioritario al a WiFi, y en el caso de la WiFi, tengo dos distintas configuradas.
Para ello, primero hay que editar el archivo ``
...
`cat /proc/partitions`
Si queremos conocer la versión de nuestra Raspberry PiRaspi
`cat /proc/version`
